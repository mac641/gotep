...
// Headers
fragment FIELDVALUE	: (ID SLASH? | ENVVARIABLE)+ NEWLINE? (NEWLINEWITHINDENT FIELDVALUE)?;
fragment FIELDNAME	: ~('\u003A' | [\u000D\u000A\u0020\u0009\u000C])+ COLON; // COLON | [\r\n \t\f]
...
fragment PORT			: DIGIT DIGIT DIGIT DIGIT DIGIT | ENVVARIABLE;
...
fragment IPV6ADDRESS : (HEX | COLON | ENVVARIABLE)+;
...
fragment QUERY				: (~'\u0023' | ENVVARIABLE) (NEWLINEWITHINDENT QUERY)?; // HASHTAG
...
// Messages
MESSAGE						: MESSAGELINE | MULTIPARTFORMDATA | ENVVARIABLE;
